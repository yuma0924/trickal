        ...
        <div className="flex items-center gap-1.5 border-t border-[rgba(249,168,212,0.1)] pt-2">
          ...
          <div className="flex gap-1.5">
            {statKeys.map((s) => (
              ...
              >
                {STAT_SHORT_LABELS[s.key] ?? s.label}{selectedStat === s.key ? "↓" : ""}
              </button>
            ))}
          </div>
        </div>
      ...
      {sortedCharacters.length === 0 ? (
        ...
        <div className="space-y-2">
          {sortedCharacters.map((character) => {
            ...
            const elemStyle = character.element ? ELEMENT_STYLES[character.element] : null;
            ...
            return (
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  {character.role && (
                    <p className="text-[10px] text-[#8b7aab]">{character.role}</p>
                  )}
                </div>
